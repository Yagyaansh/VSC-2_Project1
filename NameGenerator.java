...
//		String fileLastName = "lastNames.txt";
		InputStream firsts = this.getClass().getResourceAsStream("/resources/fissssssrstNames.txt");
		InputStream lasts = this.getClass().getResourceAsStream("/resources/lassssssstNames.txt");
